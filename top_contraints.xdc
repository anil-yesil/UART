...
set_property PACKAGE_PIN R2 [get_ports {auto_transfer}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {auto_transfer}]
...
set_property PACKAGE_PIN W3 [get_ports {status_led_o[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status_led_o[0]}]
set_property PACKAGE_PIN U3 [get_ports {status_led_o[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status_led_o[1]}]
...
set_property PACKAGE_PIN L1 [get_ports {tx_or_rx}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {tx_or_rx}]
	
	
#7 segment display
set_property PACKAGE_PIN W7 [get_ports {seg_o[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg_o[6]}]
set_property PACKAGE_PIN W6 [get_ports {seg_o[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg_o[5]}]
set_property PACKAGE_PIN U8 [get_ports {seg_o[4]}]					
...
set_property PACKAGE_PIN U5 [get_ports {seg_o[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg_o[2]}]
set_property PACKAGE_PIN V5 [get_ports {seg_o[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg_o[1]}]
set_property PACKAGE_PIN U7 [get_ports {seg_o[0]}]					
